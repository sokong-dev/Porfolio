...
const Hero: React.FC = () => {
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/sokong-dev/sokong-dev',
      icon: (
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <h2 className="text-2xl md:text-3xl font-medium text-slate-300 mb-8 reveal" style={{ transitionDelay: '100ms' }}>
            Flutter Framework | Android Development (Jetpack Compose) 
          </h2>
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mb-10 leading-relaxed reveal" style={{ transitionDelay: '200ms' }}>
            Building scalable, high-performance mobile applications for Android and iOS by using Flutter. Focused on clean architecture and seamless user experiences.
          </p>
